...
<!--
ИНСТРУКЦИЯ:
1. Скопируй этот файл, переименуй в `кандидат-01.md`, `кандидат-02.md` и т.д.
2. Замени XX в заголовке на номер.
3. Заполни поля ниже. Поле «Моё впечатление» — твоими словами, как чувствуется кнопка.
4. Когда наберёшь сколько хочешь — скажи мне «готово, посмотри».
-->

**Ссылка:** https://uiverse.io/comported_2449/bad-snail-2

**Тип:** cta / toggle / icon
<!-- cta = прямоугольная кнопка действия (Запросить, Скачать)
     toggle = переключатель (м²/кг, RU/EN, ON/OFF)
     icon = со стрелкой / play / иконкой -->

**Автор на Uiverse:** 
https://github.com/marcelodolza
Keyboard Button Replica
Replicate this 3D key button using code.
...
Join the challenge
Follow the instructions and submit your entry before the deadline

Cast your vote
You get 3 votes - use them to support the submissions you think nailed it

Celebrate the winners
The top 3 winners will earn up to 2000 Uiverse points and bragging rights

**Моё впечатление:**
<отличные кнопки и еще и со светодиодным индикатором их там куча 
вот кстати его страница https://x.com/cerpow
и сайт у него прикольный https://dolza.dev/
---
...
<label class="wrap" for="button">
  ...
  <button class="button">
    ...
    <div class="inner">
      ...
      >
        <g class="symbol" filter="url(#inset-shadow)">
          <path
            fill-rule="evenodd"
            clip-rule="evenodd"
  ...
  <svg width="100%" height="100%">
    <defs>
      ...
      >
        ...
        <rect width="500" height="500" filter="url(#noise)"></rect>
      </pattern>
    </defs>
    <rect width="100%" height="100%" fill="url(#noise-pattern)"></rect>
  </svg>
</div>
