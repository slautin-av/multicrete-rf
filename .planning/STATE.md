...
- ANKETA (опросный лист подбора покрытия) — СЛЕДУЮЩАЯ ЦЕЛЬ v2 (вынесена из v1.0 решением 2026-06-29). Уточнение объёма 2026-06-30: нужны ДВА способа — (1) заполнить онлайн прямо на сайте; (2) скачать пустой бланк, заполнить офлайн и прислать на e-mail для расчёта. Предусловие планирования: Алексей присылает существующий бумажный бланк-опросник → разбираем и берём за основу формы/бланка.
